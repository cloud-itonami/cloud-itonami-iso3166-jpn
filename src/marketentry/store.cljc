(ns marketentry.store
  "SSoT for the Japan market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Fabrication KK" :portal "GEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-japan-resident-rep? true :has-japan-resident-rep? true
             :requires-corporate-number? true :corporate-number-verified? true
             :drafted? false :submitted? false
             :jurisdiction "JPN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "GEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-japan-resident-rep? true :has-japan-resident-rep? true
             :requires-corporate-number? true :corporate-number-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "GEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "JPN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "GEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-japan-resident-rep? true :has-japan-resident-rep? false
             :requires-corporate-number? true :corporate-number-verified? true
             :drafted? false :submitted? false
             :jurisdiction "JPN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "GEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-japan-resident-rep? true :has-japan-resident-rep? true
             :requires-corporate-number? true :corporate-number-verified? false
             :drafted? false :submitted? false
             :jurisdiction "JPN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "GEPS"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-japan-resident-rep? has-japan-resident-rep?
                               requires-corporate-number? corporate-number-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-japan-resident-rep?)  (assoc :engagement/requires-japan-resident-rep? requires-japan-resident-rep?)
    (some? has-japan-resident-rep?)       (assoc :engagement/has-japan-resident-rep? has-japan-resident-rep?)
    (some? requires-corporate-number?)    (assoc :engagement/requires-corporate-number? requires-corporate-number?)
    (some? corporate-number-verified?)    (assoc :engagement/corporate-number-verified? corporate-number-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-japan-resident-rep? :engagement/has-japan-resident-rep?
   :engagement/requires-corporate-number? :engagement/corporate-number-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-japan-resident-rep? (boolean (:engagement/requires-japan-resident-rep? m))
     :has-japan-resident-rep? (boolean (:engagement/has-japan-resident-rep? m))
     :requires-corporate-number? (boolean (:engagement/requires-corporate-number? m))
     :corporate-number-verified? (boolean (:engagement/corporate-number-verified? m))
