...
(defn -main [& _]
  (let [db (store/seed-db)
    ...
    (println "== jurisdiction/assess eng-4 (sets up japan-resident-rep-missing) ==")
    ...
    (println "== filing/submit eng-4 (japan-resident-rep-missing -> HARD hold) ==")
    (println (exec-op actor "t9" {:op :filing/submit :subject "eng-4"} operator))

    (println "== jurisdiction/assess eng-5 (sets up corporate-number-unverified) ==")
    ...
    (println "== filing/submit eng-5 (corporate-number-unverified -> HARD hold) ==")
