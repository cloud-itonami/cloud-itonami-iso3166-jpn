...
`cloud-itonami-iso3166-jpn` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
representation the law of Japan requires for public-procurement
filings.
